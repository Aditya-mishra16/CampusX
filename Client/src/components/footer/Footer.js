			...
			<div className = 'footer py-3 pb-4'>
				<div className = 'container'>
					...
					<div className = 'row mb-4'>
						<div className = 'c col-lg-4 col-md-6 col-12'>
							<div className = 's mb-3 mb-md-0'>
								<h6 className = 'footer-title mb-3'>CampusX</h6>
								<p className = 'footer-text'>The project focused on the 3D modeling of a dispersed campus, with the dual purpose of creating virtual tours of the University's cultural heritage sites and developing a new website for the campus area.</p>
								<h6 className = 'footer-e-mail text-muted'><i className = 'fas fa-envelope me-2'></i>campusX@support.com</h6>
							</div>
						</div>
					...
					<div className = 'copyrights text-center'>
						<p className="small text-muted mb-0">&copy; Copyrights. All rights reserved. <Link to = "/">CampusX</Link></p>
					</div>
				</div>
			</div>
		)
